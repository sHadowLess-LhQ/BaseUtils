 ...
 * @author sHadowLess
 */
public abstract class BaseDialog<VB extends ViewBinding> extends Dialog implements View.OnClickListener, RxUtils.RxLifecycleObserver, LifecycleProvider<Lifecycle.Event> {
