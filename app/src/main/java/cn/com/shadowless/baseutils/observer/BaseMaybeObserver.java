...
public abstract class BaseMaybeObserver<T> implements MaybeObserver<T> {
     ...
     */
    public BaseMaybeObserver(Activity activity) {
     ...
     */
    public BaseMaybeObserver(Activity activity, LoadingPopupView loadingPopupView) {
     ...
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel) {
     ...
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel, String loadName) {
     ...
     * @param loadName      the load name
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel, boolean canBackCancel, String loadName) {
     ...
     * @param loadName         the load name
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel, boolean canBackCancel, boolean canOutSideCancel, String loadName) {
     ...
     * @param loadName         the load name
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel, boolean canBackCancel, boolean canOutSideCancel, boolean hasBlurBg, String loadName) {
     ...
     * @param loadName         the load name
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel, boolean canBackCancel, boolean canOutSideCancel, boolean hasBlurBg, boolean hasShadow, String loadName) {
     ...
     * @param loadName         the load name
     */
    public BaseMaybeObserver(Activity activity, boolean isViewModel, boolean canBackCancel, boolean canOutSideCancel, boolean hasBlurBg, boolean hasShadow, boolean canCancel, String loadName) {
