...
package cn.com.shadowless.baseutils.crash.activity;
...
import cn.com.shadowless.baseutils.crash.CustomActivityOnCrash;
...
public final class DefaultErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (config.isShowRestartButton() && config.getRestartActivityClass() != null) {
            restartButton.setText(R.string.custom_activity_on_crash_error_activity_restart_app);
        ...
        if (config.isShowErrorDetails()) {
            moreInfoButton.setOnClickListener(v -> {
                ...
                AlertDialog dialog = new AlertDialog.Builder(DefaultErrorActivity.this)
                        .setTitle(R.string.custom_activity_on_crash_error_activity_error_details_title)
                        .setMessage(CustomActivityOnCrash.getAllErrorDetailsFromIntent(DefaultErrorActivity.this, getIntent()))
                        .setPositiveButton(R.string.custom_activity_on_crash_error_activity_error_details_close, null)
                        .setNeutralButton(R.string.custom_activity_on_crash_error_activity_error_details_copy,
    ...
    private void copyErrorToClipboard() {
        ...
        if (clipboard != null) {
            ...
            Toast.makeText(DefaultErrorActivity.this, R.string.custom_activity_on_crash_error_activity_error_details_copied, Toast.LENGTH_SHORT).show();
        }
    }
}
