 ...
 * @author sHadowLess
 */
public abstract class BaseHorizontalAttachPopView<VB extends ViewBinding> extends HorizontalAttachPopupView implements LifecycleProvider<Lifecycle.Event>{
