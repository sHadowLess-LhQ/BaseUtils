...
public abstract class BaseLifeCompletableObserver implements CompletableObserver {
     ...
     */
    public BaseLifeCompletableObserver(LoadingPopupView loadingPopupView, boolean isSmartDismiss) {
     ...
     */
    public BaseLifeCompletableObserver(Activity activity, LoadingConfig config) {
