 ...
 * @author sHadowLess
 */
public abstract class BaseHorizontalAttachPopView<VB extends ViewBinding> extends HorizontalAttachPopupView implements LifecycleProvider<Lifecycle.Event>, View.OnClickListener {
     ...
     * @param context the 上下文
     */
    public BaseHorizontalAttachPopView(@NonNull Context context, Lifecycle lifecycle) {
        super(context);
        this.context = context;
