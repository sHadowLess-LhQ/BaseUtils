...
package cn.com.shadowless.baseutils.crash;
...
import cn.com.shadowless.baseutils.crash.activity.DefaultErrorActivity;
import cn.com.shadowless.baseutils.crash.config.CrashConfig;

/**
 * The type Custom activity on crash.
 *
 * @author sHadowLess
 */
public final class CustomActivityOnCrash {
    ...
    /**
     * The constant SHARED_PREFERENCES_FIELD_TIMESTAMP.
     */
    ...
    public interface EventListener extends Serializable {
        /**
         * On launch error activity.
         */
        void onLaunchErrorActivity();

        /**
         * On restart app from error activity.
         */
        void onRestartAppFromErrorActivity();

        /**
         * On close app from error activity.
         */
